  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { prefixes.git.hunk.keys, group = prefixes.git.hunk.name },
        { prefixes.code_actions.keys, group = prefixes.code_actions.name },
        { prefixes.buffer.keys, group = prefixes.buffer.name },
        { prefixes.tabs.keys, group = prefixes.tabs.name },
      },
    },
  },
}
